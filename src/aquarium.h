...
const struct {
  ...
  uint8_t button_blue;  // digital_2
  uint8_t button_green; // digital_3
  uint8_t button_red;   // digital_4
  uint8_t led_red;      // digital_5
  uint8_t led_yellow;   // digital_6
